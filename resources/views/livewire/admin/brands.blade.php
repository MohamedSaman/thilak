<div class="container-fluid py-2">
    ...
    <div class="card-header text-white p-5  d-flex align-items-center"
        ...
        <div>
            <h3 class="mb-1 fw-bold tracking-tight text-white">Product Brand Details</h3>
            <p class="text-white opacity-80 mb-0 text-sm">Monitor and manage your Product Brand Details</p>
        </div>
    </div>
            ...
            <table class="table table-sm">
                ...
                <tbody>
                    ...
                    <tr class="transition-all hover:bg-gray-50">
                        <td class="text-sm text-center ps-4 py-3">{{ $brand->id }}</td>
                        <td class="text-sm text-center py-3">{{ $brand->brand_name }}</td>
                        <td class="text-sm text-center py-3">{{ $brand->notes }}</td>
                        <td class="text-sm text-center py-3">{{ $brand->created_at->format('d/m/Y') }}</td>
                        <td class="text-center py-3">
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                <button
                                    ...
                                    wire:click="toggleDeleteModal({{ $brand->id }})"
                                    title="Delete">
                    ...
                    <tr>
                        <td colspan="5" class="text-center py-4" style="color: #233D7F;">
                            <i class="bi bi-exclamation-circle me-2"></i>No brands found.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow-xl overflow-hidden" style="border: 2px solid #233D7F; background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                <div class="modal-header py-3 px-4" style="background-color: #233D7F; color: white;">
                    <h5 class="modal-title fw-bold tracking-tight">Add New Brand</h5>
                ...
                <form wire:submit.prevent="save">
                    <div class="modal-body p-5">
                        <div class="mb-4">
                            <label for="name" class="form-label fw-medium" style="color: #233D7F;">Brand Name</label>
                            <input type="text" wire:model="brand_name" class="form-control border-2 shadow-sm" style="border-color: #233D7F; color: #233D7F;">
                            @error('brand_name') <div class="text-danger small mt-1">{{ $message }}</div> @enderror
                        </div>
                        <div class="mb-4">
                            <label for="note" class="form-label fw-medium" style="color: #233D7F;">Note</label>
                            <textarea wire:model="notes" class="form-control border-2 shadow-sm" rows="4" style="border-color: #233D7F; color: #233D7F;"></textarea>
    ...
    <div class="modal fade show d-block" tabindex="-1" style="background-color: rgba(0, 0, 0, 0.6); backdrop-filter: blur(4px);">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow-xl overflow-hidden" style="border: 2px solid #233D7F; background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                <div class="modal-header py-3 px-4" style="background-color: #233D7F; color: white;">
                    <h5 class="modal-title fw-bold tracking-tight">Edit Brand</h5>
                ...
                <form wire:submit.prevent="update">
                    <div class="modal-body p-5">
                        <div class="mb-4">
                            <label for="edit-name" class="form-label fw-medium" style="color: #233D7F;">Brand Name</label>
                            <input type="text" wire:model="brand_name" class="form-control border-2 shadow-sm" style="border-color: #233D7F; color: #233D7F;">
                            @error('brand_name') <div class="text-danger small mt-1">{{ $message }}</div> @enderror
                        </div>
                        <div class="mb-4">
                            <label for="edit-note" class="form-label fw-medium" style="color: #233D7F;">Note</label>
                            <textarea wire:model="notes" class="form-control border-2 shadow-sm" rows="4" style="border-color: #233D7F; color: #233D7F;"></textarea>
                            @error('notes') <div class="text-danger small mt-1">{{ $message }}</div> @enderror
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow-xl overflow-hidden" style="border: 2px solid #233D7F; background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                ...
                <div class="modal-body p-5" style="color: #233D7F;">
                    <p class="mb-0">Are you sure you want to delete this Brand? This action cannot be undone.</p>
                </div>
                <div class="modal-footer py-3 px-4" style="border-top: 1px solid #233D7F; background: #f8f9fa;">
